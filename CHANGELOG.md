...
## [7.0.0](https://github.com/tohuwabohu/puppet-duplicity/tree/v7.8.0) (2025-10-09)

### Changed
              
- Raised the minimum version of puppetlabs/stdlib to 9.x
- Replaced references of deprecated `ensure_packages` with `stdlib::ensure_packages`

## [6.8.1](https://github.com/tohuwabohu/puppet-duplicity/tree/v6.8.1) (2025-10-09)

### Updated
              
- Support puppet/logrotate 9.x
